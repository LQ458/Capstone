    ...
    def analyze_winning_strategies(self, initial_numbers):
        ...
        for initial_num in initial_numbers:
            ...
            while current_num > 1:
                ...
                # 检查是否有多个选择
                possible_moves = game.get_possible_moves(current_num)
        ...
        for game_num in range(num_games):
            ...
            while current_number > 1:
                if current_player == 1:  # Minimax玩家
                    ...
                    possible_moves = game.get_possible_moves(current_number)
            ...
            game_lengths.append(len(game.get_possible_moves(initial_number)))
