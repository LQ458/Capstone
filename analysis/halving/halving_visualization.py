...
def create_game_length_analysis():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/halving_game_lengths.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_performance_scaling_chart():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/halving_performance_scaling.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_strategy_analysis_chart():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/halving_strategy_analysis.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_minimax_vs_random_comparison():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/halving_minimax_vs_random.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_decision_tree_visualization():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/halving_decision_tree.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def run_halving_analysis():
    ...
    with open('../../output/text/halving_simulation_results.json', 'w') as f:
