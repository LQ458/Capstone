...
def create_connect4_win_rate_chart():
    ...
    # Simulation data
    scenarios = ['Agent vs Random', 'Agent vs Agent (8 vs 6)', 'Agent vs Agent (8 vs 8)']
    win_rates = [85, 78, 50]  # Updated data
...
def create_depth_performance_chart():
    ...
    depths = [2, 4, 6, 8]
    win_rates = [45, 65, 85, 92]  # Updated data reflecting depth 8 performance
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/connect4_depth_performance.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_opening_move_analysis():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/connect4_opening_moves.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def create_game_length_distribution():
    ...
    plt.tight_layout()
    plt.savefig('../../output/images/connect4_game_lengths.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def run_connect4_analysis():
    ...
    agent_vs_random = simulation.simulate_ai_vs_random(50, 6)
    
    print("2. Running agent vs agent simulation...")
    agent_vs_agent = simulation.simulate_ai_vs_ai(30, 6, 4)
    ...
    with open('../../output/text/connect4_simulation_results.json', 'w') as f:
